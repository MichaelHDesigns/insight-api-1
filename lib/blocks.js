  ...
  self.getPreviousBlock(prevHash, function(err, info) {
    ...
    if(info===null){
	    ...
	    if (nPrevHeight < 5465) {
	      ...
	      // 1111/((x+1)^2)
	      nSubsidy = (1250);
	      if(nSubsidy > 500) nSubsidy = 1250;
	      else if(nSubsidy < 1) nSubsidy = 1250;
	    } else if (nPrevHeight < 17000 || (dDiff <= 75 && nPrevHeight < 24000)) {
	      // CPU mining era
	      // 11111/(((x+51)/6)^2)
	      nSubsidy = (1250);
	      if(nSubsidy > 500) nSubsidy = 1250;
	      else if(nSubsidy < 25) nSubsidy = 1250;
	    } else {
	      // GPU/ASIC mining era
	      // 2222222/(((x+2600)/9)^2)
	      nSubsidy = (1250);
	      if(nSubsidy > 25) nSubsidy = 1250;
	      else if(nSubsidy < 5) nSubsidy = 1250;
	    }

	    var nSubsidy = nSubsidy;
